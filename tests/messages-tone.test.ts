...
describe("словарь и дизайн-пакет", () => {
  ...
  it("ключи, которых пакет не знает, — только экраны входа по ссылке", () => {
    ...
    expect(own).toEqual([
      ...
      // `Onboarding.wants*` ОТСЮДА УШЛИ (раунд 27, тикет 128): третий шаг
      // онбординга — «что чаще всего хочется» (тикет 113, доска 34b) — пришёл
      ...
      // дословно: сам заголовок «Или начни с готового» и форма «+40» числом.
