...
describe("словарь и дизайн-пакет", () => {
  ...
  it("ключи, которых пакет не знает, — только экраны входа по ссылке", () => {
    ...
    expect(own).toEqual([
      ...
      // Первый экран пустой комнаты (тикет 137, макет 41a). Все три строки —
      // с доски дословно: «Комната твоя. Пока в ней темно», «Каждая вещь
      // зажигает свою полку. Первая — самая заметная» и подпись единственной
      // полосы света «Вставить ссылку из магазина». В messages-ru.json дизайн
