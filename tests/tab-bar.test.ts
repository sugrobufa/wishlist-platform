...
describe("иконки — канон 25a, не рукописные", () => {
  it("пути таб-бара и замен сняты с доски посимвольно", () => {
    ...
    const canonical: Array<[string, string]> = [
      ...
      // Сокровищница — арка со скважиной (раунд 21, тикет 111). Двойная
      // звезда рисовалась под старое имя раздела и ушла вместе с ним.
      ["Сокровищница (арка)", 'd="M4.5 11.5h15V19a1.5 1.5 0 0 1-1.5 1.5H6A1.5 1.5 0 0 1 4.5 19v-7.5z"'],
      ["Сокровищница (скважина)", '<circle cx="12" cy="14.6" r="1.5"'],
