...
const DESKTOP_REACH: Array<{
  ...
  { screen: { w: 1024, h: 768 }, bleedX: 61.44, field: 64, full: 128, short: 6, gone: 0 },
  { screen: { w: 1194, h: 834 }, bleedX: 71.64, field: 43.875, full: 129, short: 5, gone: 0 },
  { screen: { w: 1280, h: 720 }, bleedX: 5.12, field: 0, full: 134, short: 0, gone: 0 },
  { screen: DESKTOP, bleedX: 76.8, field: 0, full: 129, short: 5, gone: 0 },
  { screen: { w: 1280, h: 1024 }, bleedX: 76.8, field: 112, full: 129, short: 5, gone: 0 },
  { screen: { w: 1366, h: 768 }, bleedX: 5.128, field: 0, full: 134, short: 0, gone: 0 },
  { screen: { w: 1440, h: 900 }, bleedX: 86.4, field: 0, full: 131, short: 3, gone: 0 },
...
describe("все 134 зоны достижимы: кадром или указателем (тикет 40)", () => {
  ...
  it("десктоп: на 1280×800 пальцем достаются 129 зон, 5 срезаны краем окна", () => {
  ...
  it("телефон: верхняя вуаль лежит НА зонах, нижняя до кадра не достаёт", () => {
    ...
    expect(touchedTop(PHONE)).toHaveLength(73);
    ...
    expect(touchedTop({ w: 375, h: 667 })).toHaveLength(99);
  ...
  it("телефон: цена решения — 34 зоны целиком под вуалью, и все они достижимы", () => {
    ...
    expect(swallowed).toHaveLength(34);
    ...
    expect(swallowedAt({ w: 430, h: 745 })).toBe(34);
    ...
    expect(swallowedAt({ w: 360, h: 640 })).toBe(73);
  ...
  it("десктоп: полосы лежат НА зонах, и это норма — нажатий они не берут", () => {
    ...
    expect(touched(DESKTOP)).toHaveLength(43);
