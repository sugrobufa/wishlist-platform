...
// спрятана (инвариант №5), вещь сокровищницы, ссылки нет — во всех этих
// случаях у формы нет ключа shop, и перехода быть не могло.
//
// СКРЫТАЯ ЦЕНА В ЭТОМ СПИСКЕ БОЛЬШЕ НЕ ЗНАЧИТСЯ (тикет 195): ссылку такой
// вещи гостю теперь отдают, значит и переход по ней настоящий. Список правил
// здесь не переписывался — он и не свой: правило одно, живёт в DTO, а сервис
// его только читает. Ровно ради этого оно там и стоит.
import { z } from "zod";
