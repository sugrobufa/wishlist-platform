 ...
 * три времени × два цвета, дубликаты схлопнуты. Цветов стало два вместе с
 * упразднением «свечного» (тикет 256) — счёт берётся из словарей, а не из
 * головы, поэтому здесь не поменялось ни строки.
 *
 ...
 * ВЫЗОВОМ, а не прокликиванием — сочетаний шесть на каждую из десяти баз (было
 * девять до упразднения «свечного», тикет 256), и внутри `RoomStudio` до
 * половины из них добираешься только тапами.
 *
