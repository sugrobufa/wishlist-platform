      ...
      <div className={s.column}>
        ...
        >
          ...
          {/* ПОДЛОЖКА ПОД ЗНАКАМИ — ТОЛЬКО КОГДА ПОД НИМИ ФОТОГРАФИЯ (тикет
              ...
              там они стоят на своей заливке .05, и тёмный квадрат был бы
              пятном на ровном фоне. Числа подложки — в owner-card.module.css,
              приёмом `.imm-corner-mark`. */}
        ...
        <div className={s.surface}>
          ...
          {/* Цена и огоньки — вместе, как просит round39: оба числа про одно.
              ...
              ступени, которое обычно их называет, как раз молчит. На его место
              встаёт `AddItem.desireLabel` — те же слова, что человек читал в
              форме, когда вещь заводил. Своего ключа карточка не заводит:
              подпись одного поля не может быть двумя разными строками. */}
          {!item.inHall && (
