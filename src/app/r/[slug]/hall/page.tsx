            ...
            {hall.items.map((item) => (
              <li key={item.id}>
                ...
                {/* Подпись гостю — только год: имени дарителя здесь нет и
                    ...
                    И НЕ «УЖЕ МОЁ» (тикет 249, приёмка владельца 14.08.2026:
                    «при входе на сокровищницу хозяина подпись „уже моё"
                    смущает. Оно не моё, а его»). Экран чужой, и подпись от
                    первого лица здесь читается как подпись гостя. Своего ключа
                    у неё до сих пор не было — брался ключ ХОЗЯЙКИНОЙ витрины.
                    «Уже дома» — то же, чем этот экран уже назван в своём
                    подзаголовке («всё здесь уже дома»), и оно не требует рода
                    ни человека, ни говорящего. Слово ушло дизайну письмом 60. */}
