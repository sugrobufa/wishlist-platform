 ...
 * Ночь здесь ОСТАЁТСЯ и остаться обязана: ПЯТЬ баз из десяти сняты ночью
 ...
 *
 * Число было «четыре» и врало с раунда 21 в трёх файлах разом; настоящий счёт
 * прислал дизайн пакетом 43 (emerald, bold, gamer, study, loft), и наш же
