  ...
  return (
    <div className={active ? `${s.stack} ${s.stackAway}` : s.stack}>
      {/* В ПУСТОЙ КОМНАТЕ СТРОКА ДЕЙСТВИЙ ПУСТА (тикет 199): «Добавить вещь»
          ...
          цель нажатия и оставляет ровно зазор под пилюлю-подсказку
          (globals.css → .imm-row-bare); те 19 px и есть место, которого блоку
          первого шага не хватало на 390×664. */}
