...
/**
 * «Сокровищница» — БРИЛЛИАНТ (`handoff/icons/ui-treasury.svg`, новая редакция
 * набора).
 *
 ...
 *
 * Знак угла сцены (тикет 119). Пути — из файла набора, путь в путь
 * (tests/scene-corner).
 *
 * НЕ ПУТАТЬ С `IconHall`: тот — арка со скважиной из набора таб-бара
 * (раунд 21), и он остаётся шкатулкой — место витрины в баре живо (тикет 132).
 */
