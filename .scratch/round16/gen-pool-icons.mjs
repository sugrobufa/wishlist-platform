...
const header = `// Значки пулов — раунд 15 дизайна, тикет 82. ФАЙЛ СГЕНЕРИРОВАН из
// design/round15/icons/*.svg скриптом .scratch/round16/gen-pool-icons.mjs:
...
//
// Пула \`money\` в наборе НЕТ, и это не пропуск: такого пула нет в пакете
// вовсе. У зоны без значка остаётся буква названия (тикет 68) — она честно
// говорит «фотографии нет».
